...
export const THEMES: Theme[] = [
  {
    ...
    label: "Dark",
    isDark: true,
    // Burrow's default look, aligned to the pen.dev visual language: near-black
    // bg, flat bordered surfaces (no shadows), purple accent, pill-shaped status
    // badges. See src/App.vue's :root for the surface/shape aliases (--surface,
    // --surface-elevated, --radius-*) built on top of these same vars.
    vars: {
      "bg-base": "#0A0B0F",
      "bg-panel": "#14161C",
      "bg-hover": "#1B1E26",
