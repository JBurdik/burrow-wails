...
export function ForgeInfo(arg1:string):Promise<main.ForgeStatus>;

export function ForgeInstallCLI(arg1:string):Promise<string>;

export function ForgePrCreate(arg1:string,arg2:string,arg3:string,arg4:string,arg5:string):Promise<forge.PullRequest>;

export function ForgePrList(arg1:string,arg2:string,arg3:string):Promise<Array<forge.PullRequest>>;

export function ForgePrMerge(arg1:string,arg2:number,arg3:boolean):Promise<void>;

export function ForgePrView(arg1:string,arg2:number):Promise<forge.PullRequest>;
